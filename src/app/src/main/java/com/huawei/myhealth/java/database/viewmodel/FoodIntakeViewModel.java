...
import com.huawei.myhealth.java.database.repository.FoodIntakeRepository;
 ...
 * @since 2020
 */
public class FoodIntakeViewModel extends AndroidViewModel {

    private FoodIntakeRepository foodIntakeRepository;
    int foodId = 0;

    public FoodIntakeViewModel(@NonNull Application application,
                               FoodIntakeRepository foodIntakeRepository, int foodId) {
        super(application);
    ...
    public LiveData<List<FoodIntake>> calorieTakenToday(){
        return foodIntakeRepository.calorieTakenToday();
    }
